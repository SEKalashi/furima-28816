class UserItems
  ...
  attr_accessor :nickname, :first_name, :first_kana, :family_name, :family_kana, :birthday, :email, :password, :name, :description, :status_id, :shipping_time_id, :delivery_charge_id, :category_id, :sending_area_id, :price, :image
